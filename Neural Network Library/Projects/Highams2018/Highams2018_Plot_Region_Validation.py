...
predicted_failure = plt.scatter(x_y0[:, 0], x_y0[:, 1], c='bisque',marker='s')

# Create a scatterplot for Y=1 points
predicted_success = plt.scatter(x_y1[:, 0], x_y1[:, 1], c='palegreen', marker='s')
...
vF = plt.scatter(xv[0:2, 0], xv[0:2, 1],  marker='x', s=75, color = 'red', label = 'Validation Data - Failure')
vS = plt.scatter(xv[2:4, 0], xv[2:4, 1], marker='o', s=75, color = 'red', label = 'Validation Data - Success')
